					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(etiqueta, GroupLayout.PREFERRED_SIZE, 456, GroupLayout.PREFERRED_SIZE)
								.addComponent(prioridade_label)
								.addComponent(prioridade, GroupLayout.PREFERRED_SIZE, 456, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(cancelar)
									.addPreferredGap(ComponentPlacement.RELATED, 278, Short.MAX_VALUE)
									.addComponent(editar_tarefa))
								.addComponent(data, GroupLayout.PREFERRED_SIZE, 456, GroupLayout.PREFERRED_SIZE)
								.addComponent(data_label, GroupLayout.PREFERRED_SIZE, 62, GroupLayout.PREFERRED_SIZE)
								.addComponent(titulo, GroupLayout.PREFERRED_SIZE, 456, GroupLayout.PREFERRED_SIZE)
								.addComponent(titulo_label)
								.addComponent(etiqueta_label_1, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
								.addComponent(descrisao, GroupLayout.PREFERRED_SIZE, 456, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(536)
